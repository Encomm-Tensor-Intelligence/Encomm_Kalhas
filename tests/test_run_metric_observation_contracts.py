...
class TestRegistration:
    ...
    def test_set_is_registered_before_the_phase21_matrix(self) -> None:
        ...
        assert PUBLIC_CONTRACTS[-14] is RunMetricObservationSet
        assert PUBLIC_CONTRACTS[-13].__name__ == "CampaignMetricObservationMatrix"
        assert PUBLIC_CONTRACTS[-12].__name__ == "CampaignMetricStatisticsMatrix"
        assert PUBLIC_CONTRACTS[-11].__name__ == "ScenarioEvaluationProfile"
        assert PUBLIC_CONTRACTS[-10].__name__ == "CampaignObjectiveEvaluationMatrix"
        assert PUBLIC_CONTRACTS[-9].__name__ == "WorldUncertaintyModel"
        assert PUBLIC_CONTRACTS[-8].__name__ == "WorldRealization"
        assert PUBLIC_CONTRACTS[-7].__name__ == "CampaignWorldRealizationMatrix"
        assert PUBLIC_CONTRACTS[-6].__name__ == "RealizationRunTrajectoryExecution"
        assert PUBLIC_CONTRACTS[-5].__name__ == "RealizationRunTrajectoryReplayManifest"
        assert PUBLIC_CONTRACTS[-4].__name__ == "RealizationCampaignTrajectoryMatrix"
        assert PUBLIC_CONTRACTS[-3].__name__ == "RealizationRunMetricObservationSet"
        assert PUBLIC_CONTRACTS[-2].__name__ == "RealizationCampaignMetricObservationMatrix"
        assert PUBLIC_CONTRACTS[-1].__name__ == "RealizationCampaignMetricStatisticsMatrix"
